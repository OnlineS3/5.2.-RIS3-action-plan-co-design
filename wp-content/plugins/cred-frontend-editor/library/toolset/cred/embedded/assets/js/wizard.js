        ...
        nextStep: function () {
            if (newform && 2 === self.step && !self.steps[2].completed) {
                ...
                if (cred.doCheck(self.step)) {
                    ...
                    for (var i = 0; i <= 20; i++) {
                        var $credMailBodySelector = $('#credmailbody' + i);
                        if ($credMailBodySelector && $credMailBodySelector.length) {
                    ...
                    $.ajax({
                        ...
                        data: self.serialize('#post') + '&_cred[wizard]=' + wizard_step + action_message,
                        type: 'post',
                        success: function () {
                        }
                    });
