...
<fieldset class="cred-fieldset">
    ...
    <p class="cred-label-holder cred_create_form-explain-text">
		<?php _e( 'Role of the user:', 'wp-cred' ); ?>
    </p>
            ...
            <tr>
                ...
                <td>
                    <p class='cred-explain-text'>
						<?php _e( 'Enter the message to display instead of the form. You can use HTML and shortcodes. (but no Toolset User Forms)', 'wp-cred' ); ?>
                    </p>
